...
class Resume extends JFrame implements ActionListener {
    ...
    Resume()
    {
        ...
        JLabel collegeJLabel= new JLabel("Experience");
        JLabel degreeJLabel= new JLabel("College Name");
        JLabel linkedlnJLabel= new JLabel("Contact Number");
        JLabel githubJLabel= new JLabel("HackerRank link");
        JLabel hackerJLabel= new JLabel("Github link");
        JLabel contactJLabel= new JLabel("Linkedin link");
        JLabel experienceLabel= new JLabel("Degree");
